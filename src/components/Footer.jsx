    ...
    <footer className="bg-ink text-cream/80 mt-24">
      <div className="max-w-7xl mx-auto px-6 lg:px-10 py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          <div>
            <Link to="/" className="font-display text-2xl text-cream block mb-3">
              Walker Web Studios
            </Link>
          ...
          <div>
            <h4 className="font-display text-cream text-sm uppercase tracking-widest mb-4">
              Explore
            </h4>
            <ul className="space-y-2 text-sm">
              <li><a href="/#work" className="hover:text-cream transition-colors">Work</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li className="text-cream/60">Brooklyn, NY</li>
            </ul>
          </div>
        </div>

        <div className="border-t border-cream/10 pt-8 flex flex-col md:flex-row justify-between items-start md:items-center gap-4 text-xs text-cream/50">
          <p>© {new Date().getFullYear()} Walker Web Studios. All rights reserved.</p>
          <p className="font-display italic">Designed and built in-house.</p>
        </div>
      </div>
    </footer>
  )
